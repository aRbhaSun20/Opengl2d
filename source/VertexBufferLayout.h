...
// inline const std::vector<VertexBufferElement> GetElements() const { return VertexBufferLayout::m_Elements; }
// inline unsigned int GetStride() const { return VertexBufferLayout::m_Stride; }